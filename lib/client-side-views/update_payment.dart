...
Future main() async {
  ...
  runApp(new UpdateSubs());
}

class UpdateSubs extends StatefulWidget {
  var url;
  UpdateSubs({Key? key, this.url}) : super(key: key);

  @override
  _UpdateSubsState createState() => new _UpdateSubsState();
}

class _UpdateSubsState extends State<UpdateSubs> {
