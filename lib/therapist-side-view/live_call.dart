...
class LiveVideoOnAudioForTherapist extends StatefulWidget {
  int? sessionId;
  LiveVideoOnAudioForTherapist({Key? key, this.sessionId}) : super(key: key);

  @override
  _LiveVideoOnAudioForTherapistState createState() =>
      _LiveVideoOnAudioForTherapistState();
}

class _LiveVideoOnAudioForTherapistState
    extends State<LiveVideoOnAudioForTherapist> {
  @override
  void dispose() {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<MainViewModel>.reactive(
      ...
      onModelReady: (model) async {
        await model.initForAgoraOnCallForTherapist();
      },
